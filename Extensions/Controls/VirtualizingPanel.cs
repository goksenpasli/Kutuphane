...
namespace Extensions
{
    public class UniformGridPanel : VirtualizingPanel, IScrollInfo
    {
        ...
        public void LineDown() => SetVerticalOffset(_offset.Y + _scrollLength);

        public void LineLeft() => SetHorizontalOffset(_offset.X - _scrollLength);

        public void LineRight() => SetHorizontalOffset(_offset.X + _scrollLength);

        public void LineUp() => SetVerticalOffset(_offset.Y - _scrollLength);

        public Rect MakeVisible(System.Windows.Media.Visual visual, Rect rectangle) => new();
        ...
        public void PageDown() => SetVerticalOffset(_offset.Y + _viewport.Width);
        ...
        public void PageUp() => SetVerticalOffset(_offset.Y - _viewport.Width);
